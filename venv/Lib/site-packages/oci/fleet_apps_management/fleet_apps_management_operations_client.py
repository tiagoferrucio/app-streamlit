...
class FleetAppsManagementOperationsClient(object):
    ...
    def create_scheduler_definition(self, create_scheduler_definition_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.135.1/fleetappsmanagement/create_scheduler_definition.py.html>`__ to see an example of how to use create_scheduler_definition API.
        """
    ...
    def delete_scheduler_definition(self, scheduler_definition_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.135.1/fleetappsmanagement/delete_scheduler_definition.py.html>`__ to see an example of how to use delete_scheduler_definition API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def delete_scheduler_job(self, scheduler_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.135.1/fleetappsmanagement/delete_scheduler_job.py.html>`__ to see an example of how to use delete_scheduler_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_execution(self, scheduler_job_id, job_activity_id, resource_id, execution_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.135.1/fleetappsmanagement/get_execution.py.html>`__ to see an example of how to use get_execution API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_job_activity(self, scheduler_job_id, job_activity_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.135.1/fleetappsmanagement/get_job_activity.py.html>`__ to see an example of how to use get_job_activity API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_scheduler_definition(self, scheduler_definition_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.135.1/fleetappsmanagement/get_scheduler_definition.py.html>`__ to see an example of how to use get_scheduler_definition API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['schedulerDefinitionId']
        resource_path = "/schedulerDefinitions/{schedulerDefinitionId}"
    ...
    def get_scheduler_job(self, scheduler_job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.135.1/fleetappsmanagement/get_scheduler_job.py.html>`__ to see an example of how to use get_scheduler_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['schedulerJobId']
        resource_path = "/schedulerJobs/{schedulerJobId}"
    ...
    def list_executions(self, scheduler_job_id, job_activity_id, resource_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.135.1/fleetappsmanagement/list_executions.py.html>`__ to see an example of how to use list_executions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_scheduled_fleets(self, scheduler_definition_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.135.1/fleetappsmanagement/list_scheduled_fleets.py.html>`__ to see an example of how to use list_scheduled_fleets API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['schedulerDefinitionId']
    ...
    def list_scheduler_definitions(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.135.1/fleetappsmanagement/list_scheduler_definitions.py.html>`__ to see an example of how to use list_scheduler_definitions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/schedulerDefinitions"
    ...
    def list_scheduler_jobs(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.135.1/fleetappsmanagement/list_scheduler_jobs.py.html>`__ to see an example of how to use list_scheduler_jobs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def update_scheduler_definition(self, scheduler_definition_id, update_scheduler_definition_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.135.1/fleetappsmanagement/update_scheduler_definition.py.html>`__ to see an example of how to use update_scheduler_definition API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['schedulerDefinitionId']
        resource_path = "/schedulerDefinitions/{schedulerDefinitionId}"
    ...
    def update_scheduler_job(self, scheduler_job_id, update_scheduler_job_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.135.1/fleetappsmanagement/update_scheduler_job.py.html>`__ to see an example of how to use update_scheduler_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['schedulerJobId']
        resource_path = "/schedulerJobs/{schedulerJobId}"
